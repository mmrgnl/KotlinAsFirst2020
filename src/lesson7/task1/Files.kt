...
fun myFun(inputName: String, range: String): Double {
    ...
    if (counts.indexOf(range[0].toString()) > counts.indexOf(range[4].toString())) {
        l2 = counts.indexOf(range[0].toString())
        l1 = counts.indexOf(range[4].toString())
    } else {
        l1 = counts.indexOf(range[0].toString())
        l2 = counts.indexOf(range[4].toString())
    }
...
fun Demo(inputName: String, outputName: String): Int {
    var res = 0
    val writer = File(outputName).bufferedWriter()
